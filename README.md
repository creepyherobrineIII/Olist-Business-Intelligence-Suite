...
An end-to-end business intelligence suite for the Brazilian E-commerce company Olist, based on order data from the years 2016 to 2018 (incl.). Primary technologies used are: Python, Power BI, SQL 

- Architecting a multi-stage Data Engineering Pipeline in Jupyter Notebook to integrate 5+ relational datasets (100k+ rows), transforming raw CSVs into an analysis-ready schema.
